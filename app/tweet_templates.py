...
# By default green background color for new_stars stats, is overwritten at end of update with white.
...
⭐ New stars: <span style='background-color: #32CD32'>{new_stars}</span><br>
